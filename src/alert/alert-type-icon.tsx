...
const AlertTypeIcon = (props: { type: AlertType }) => (
  <svg
    ...
    class={`b-icon ${props.type === 'danger' ? 'b-icon-error' : `b-icon-${props.type}`}`}
  >
    {(() => {
      switch (props.type) {
        case 'success':
        ...
        case 'info':
          return (
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              <g fill-rule="nonzero">
                <path
                  class="b-icon-info-outer"
                  d="M8,0 C3.6,0 0,3.6 0,8 C0,12.4 3.6,16 8,16 C12.4,16 16,12.4 16,8 C16,3.6 12.4,0 8,0 Z"
                ></path>
                <path
                  class="b-icon-info-inner"
        ...
        case 'danger':
          return (
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              <g fill-rule="nonzero">
                <path
                  class="b-icon-error-outer"
                  d="M8,0 C3.6,0 0,3.6 0,8 C0,12.4 3.6,16 8,16 C12.4,16 16,12.4 16,8 C16,3.6 12.4,0 8,0 Z"
                ></path>
                <path
                  class="b-icon-error-inner"
